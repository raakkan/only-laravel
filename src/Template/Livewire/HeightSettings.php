...
class HeightSettings extends Component implements HasForms
{
    ...
    {
        return $form
            ->schema($this->getHeightSettingFields())->statePath('settings');
    }
    ...
    public function getHeightSettingFields()
    {
        if (isset($this->templateModel)) {
            return $this->getTemplate()->getHeightSettingFields();
        } else {
            return $this->getBlock()->getHeightSettingFields();
        }
    }
